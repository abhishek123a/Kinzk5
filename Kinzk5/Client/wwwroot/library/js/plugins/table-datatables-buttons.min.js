var TableDatatablesButtons = function () {
    var e = function () {
        ...
        var e = $("#sample_2"); e.dataTable({
            ...
            order: [[0, "asc"]], lengthMenu: [[5, 10, 15, 20, -1], [5, 10, 15, 20, "All"]],
        ...
        var e = new Datatable; e.init({
            src: $("#datatable_ajax"),
            onSuccess: function (e, t) { }, onError: function (e) { }, onDataLoad: function (e) { },
            loadingMessage: "Loading...", dataTable: {
                ...
                order: [[1, "asc"]],
                buttons: [{ extend: "print", className: "btn default" },
                    { extend: "copy", className: "btn default" }, { extend: "pdf", className: "btn default" },
                    { extend: "excel", className: "btn default" }, { extend: "csv", className: "btn default" },
                    {
